...
public class SystemTest {
    ...
    // define methods to set up a suitably advanced system configuration
    
    public void addDStationsSetup(){
        // add docking stations
        // exercises the use cases "AddDStation" and "AddDPoint"
        input("1 07:00, HubTerminal, ht, addDStation, A,   0,   0, 5");
        input("1 07:00, HubTerminal, ht, addDStation, B, 400, 300, 3");
    }
    
    public void addBikesSetup(){
        // add three bikes to station A
        // exercises the use case "AddBike"
        input ("2 08:00, BikeSensor, A.1.bs , dockBike, bike-1");
        expect("2 08:00, OKLight, A.1.ok, flashed");
        expect("2 08:00, BikeLock, A.1.bl, locked");
        
        input ("2 08:00, BikeSensor, A.2.bs , dockBike, bike-2");
        expect("2 08:00, OKLight, A.2.ok, flashed");
        expect("2 08:00, BikeLock, A.2.bl, locked");
        
        input ("2 08:00, BikeSensor, A.3.bs , dockBike, bike-3");
        expect("2 08:00, OKLight, A.3.ok, flashed");
        expect("2 08:00, BikeLock, A.3.bl, locked");
    }
    
    public void registerUserSetup(){
        // register user Alice
        // exercises the use case "RegisterUser"
    ...
    public void hireBikeSetup(){
        // initiate a bike hire for user Alice
        // exercises the use case HireBike
        input ("3 09:00, KeyReader, A.2.kr, insertKey, A.ki-1");
        expect ("3 09:00, OKLight, A.2.ok, flashed");
        expect ("3 09:00, BikeLock, A.2.bl, unlocked");
    }
    
    public void returnBikeSetup(){
        // return the bike
        // exercises the use case ReturnBike
        input ("3 12:30, BikeSensor, A.2.bs , dockBike, bike-2");
        expect("3 12:30, OKLight, A.2.ok, flashed");
        expect("3 12:30, BikeLock, A.2.bl, locked");
    }
    
    
    /**
     * Run the "AddBike" use case.
     * 
     */
    @Test
    public void addBike() {
    ...
    /**
     * Run the "HireBike" use case with a bike in the docking point.
     *
     */
    @Test
    public void hireBike1() {
    ...
    /**
     * Run the "HireBike" use case without a bike in the docking point.
     *
     */
    @Test
    public void hireBike2() {
        logger.info("Starting test: hireBike");
        ...
        input ("2 08:00, KeyReader, B.2.kr, insertKey, A.ki-1");
        expect("2 08:00, DSTouchScreen, B.ts, noBikeError, There is no bike available at the docking point");
    }
    
    /**
     * Run the "ReturnBike" use case.
     * 
     */
    ...
    /**
     * Run the "ViewUserActivity" use case.
     * 
     */
    @Test
    public void viewUserActivity() {
        ...
        input("3 13:00, DSTouchScreen, A.ts, viewActivity");
        expect("3 13:00, DSTouchScreen, A.ts, insertKey");
        input("3 13:00, KeyReader, A.kr, insertKey, A.ki-1");
        expect("3 13:00, DSTouchScreen, A.ts, viewActivity, ordered-tuples, 4,"
	...
	*/
    /**
     * Run the "FindFreePoints" use case.
     * 
	...
	*/
    ...
    public void testKeyReaderAndOKLight() {
        ...
        expect("2 09:30, DSTouchScreen, B.ts, noBikeError, There is no bike available at the docking point");
    }
