...
public class DSTouchScreen extends AbstractIODevice {
    ...
    public void displayActivity(List<String> activityData){
        logger.fine(getInstanceName());
        
        String deviceClass = "DSTouchScreen";
        String deviceInstance = getInstanceName();
        String messageName = "viewActivity";
    ...
    public void noBikeError(){
    	...
    	String deviceClass = "DSTouchScreen";
        String deviceInstance = getInstanceName();
        String messageName = "noBikeError";
        
        List<String> messageArgs = new ArrayList<String>();
        messageArgs.add("There is no bike available at the docking point");
    ...
    /* 
     * 
     * SUPPORT FOR showUserActivity OUTPUT MESSAGE
     * 
     */
    ...
    public void setDockingObserver(BikeDockingObserver o) {
