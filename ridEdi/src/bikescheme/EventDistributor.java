...
public class EventDistributor {
    ...
    private Map<String,InputCapableDevice> deviceMap;
    
    public EventDistributor() {
        inputEventQueue = new LinkedList<Event>();
        deviceMap = new HashMap<String,InputCapableDevice>();
    }
     ...
     * @param d
     */
    public void addInputCapableDevice(InputCapableDevice d) {
